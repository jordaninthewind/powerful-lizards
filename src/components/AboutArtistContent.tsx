...
import { EyebrowRow } from './EyebrowRow';

interface AboutArtistContentProps {
  animated?: boolean;
}

function anim(delay: string, animated: boolean) {
  return animated ? `hp-anim ${delay}` : undefined;
}
  ...
  return (
    <>
      ...
      <div className="hp-about-text">
        <div className={anim('hp-d1', animated)}>
        ...
        <p
          className={`t-body${animated ? ' hp-anim hp-d4' : ''}`}
